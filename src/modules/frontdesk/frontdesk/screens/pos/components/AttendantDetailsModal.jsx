            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl max-h-[85vh] flex flex-col overflow-hidden">
                ...
                <div className="bg-slate-900 text-white p-6 flex items-center justify-between shrink-0">
                    <div>
                        ...
                        <p className="text-slate-400 text-sm mt-1">Transaction History & Clearance</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="bg-slate-50 border-b p-4 flex items-center justify-between">
                    <div className="flex gap-1 bg-slate-200 p-1 rounded-lg">
                        ...
                        >
                            <Clock size={16} />
                            Pending Sales
                            <span className={cn("ml-1 px-1.5 py-0.5 rounded-full text-xs", activeTab === "pending" ? "bg-blue-100 text-blue-700" : "bg-slate-300 text-slate-700")}>
                        ...
                        >
                            <History size={16} />
                            Cleared History
                            <span className={cn("ml-1 px-1.5 py-0.5 rounded-full text-xs", activeTab === "cleared" ? "bg-green-100 text-green-700" : "bg-slate-300 text-slate-700")}>
                    ...
                    <div className="text-right">
                        ...
                        <div className={cn("text-2xl font-bold", activeTab === "pending" ? "text-amber-600" : "text-slate-700")}>
                ...
                {/* Transaction List */}
                <div className="flex-1 overflow-y-auto p-4 bg-slate-100/50 space-y-3 custom-scrollbar">
                    {displayedTransactions.length === 0 ? (
                        ...
                        displayedTransactions.map((tx) => (
                            <div
                                key={`${tx.pumpId}-${tx.id}`}
                                className="bg-white border hover:border-blue-300 transition-colors p-4 rounded-xl shadow-sm flex items-center justify-between group"
                            >
